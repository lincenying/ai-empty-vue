...
import { charsetRemoval, designHeight, designMultiple, designWidth, fontSize, minWidth, minWindow, needRem } from './src/design.config.ts'
        ...
        plugins: [
            ...
            ...needRem ? [
                viewport({
                    ...
                    // 与 design.config 中 fontSize 配合：转出 rem ≈ 稿面 px ÷ fontSize（再乘 html 的 font-size 得到最终像素）
